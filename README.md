...
The code operates with a dictonary ```model_parameters``` that consits of several sections, each corresponds to atmoshpere, sea ice, soil and water content, respectively. If the dictonary is not specified a default will be used.
